...
pub struct Asset {
    ...
    pub portrait_url: Url,
    pub landscape_url: Url,
    pub widget_url: Url,
    pub minibar_url: Url,
    pub minibar_landscape_url: Url,
    pub minibar_portrait_url: Url,
    pub landscape_16_10_url: Url,
    ...
    pub portrait_4_5_url_padding: Padding,
    pub video_url: Value,
